...
from app.schemas.agent import ResearchPlan, Source, SubQuestion
...
class WebResearchAgent:
    ...
    async def run(self, sub_question: SubQuestion) -> list[Source]:
        ...
        if sub_question.research_type != "web":
            logger.warning("WebResearchAgent received non-web question", type=sub_question.research_type)
            return []
